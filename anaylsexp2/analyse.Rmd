...
```{r echo=FALSE}
barplot(table(DTFormCustom$age), xlab="Age", ylab="Nombre de personnes", main="Répartition de la population par âge",las=2)
#barplot(table(DTForm$metier), xlab="Métier", ylab="Nombre de personnes", main="Répartition de la population par métier",las=2)
barplot(table(DTFormCustom$frequence), xlab="Fréquence", ylab="Nombre de personnes", main="Fréquence de jeu",las=2)
...
barplot(table(DTFormCustom$minecraft), xlab="Expérience", ylab="Nombre de personnes", main="Expérience de Minecraft",las=2)
barplot(table(DTFormCustom$similaire), xlab="Expérience", ylab="Nombre de personnes", main="Expérience de jeux émergents",las=2)
```
...
wilcox.test(DTFormCustom$agency1 + 1, mu = 3, alternative = "less")
...
wilcox.test(DTFormCustom$agency2 + 1, mu = 3, alternative = "greater")
...
wilcox.test(DTFormCustom$agency3 + 1, mu = 3, alternative = "less")
...
wilcox.test(DTFormCustom$coherence1 + 1, mu = 3, alternative = "greater")
...
wilcox.test(DTFormCustom$coherence2 + 1, mu = 3, alternative = "greater")
...
wilcox.test(DTFormCustom$coherence3 + 1, mu = 3, alternative = "greater")
...
wilcox.test(DTFormCustom$incertitude1 + 1, mu = 3, alternative = "greater")
...
wilcox.test(DTFormCustom$incertitude2 + 1, mu = 3, alternative = "greater")
...
wilcox.test(DTFormCustom$incertitude3 + 1, mu = 3, alternative = "greater")

psych::alpha(cbind(DTFormCustom$incertitude1 + 1, DTFormCustom$incertitude2 + 1, DTFormCustom$incertitutde3 + 1), keys = c(1, -1, -1))
...
wilcox.test(DTFormCustom$espace1 + 1, mu = 3, alternative = "greater")
...
wilcox.test(DTFormCustom$espace2 + 1, mu = 3, alternative = "greater")
...
wilcox.test(DTFormCustom$espace3 + 1, mu = 3, alternative = "less")
...
wilcox.test(DTFormCustom$narratif1 + 1, mu = 3, alternative = "less")
...
wilcox.test(DTFormCustom$narratif2 + 1, mu = 3, alternative = "greater")
...
wilcox.test(DTFormCustom$narratif3 + 1, mu = 3, alternative = "less")
...
wilcox.test(DTFormCustom$narratif4 + 1, mu = 3, alternative = "greater")
...
wilcox.test(DTFormCustom$narratif5 + 1, mu = 3, alternative = "less")
...
wilcox.test(DTFormCustom$narratif6 + 1, mu = 3, alternative = "less")
...
wilcox.test(DTFormCustom$narratif7 + 1, mu = 3, alternative = "less")
...
wilcox.test(DTFormCustom$narratif8 + 1, mu = 3, alternative = "greater")
...
wilcox.test(DTFormCustom$narratif9 + 1, mu = 3, alternative = "greater")
...
wilcox.test(DTFormCustom$narratif10 + 1, mu = 3, alternative = "less")
...
wilcox.test(DTFormCustom$narratif11 + 1, mu = 3, alternative = "greater")
```
...
wilcox.test(DTFormCustom$processus1 + 1, mu = 3, alternative = "less")
...
wilcox.test(DTFormCustom$processus2 + 1, mu = 3, alternative = "less")
...
wilcox.test(DTFormCustom$processus3 + 1, mu = 3, alternative = "less")
...
wilcox.test(DTFormCustom$processus4 + 1, mu = 3, alternative = "less")
...
wilcox.test(DTFormCustom$processus5 + 1, mu = 3, alternative = "less")
...
wilcox.test(DTFormCustom$processus6 + 1, mu = 3, alternative = "less")
...
wilcox.test(DTFormCustom$processus7 + 1, mu = 3, alternative = "less")
...
wilcox.test(DTFormCustom$processus8 + 1, mu = 3, alternative = "two.sided")
...
wilcox.test(DTFormCustom$processus9 + 1, mu = 3, alternative = "greater")
...
wilcox.test(DTFormCustom$processus10 + 1, mu = 3, alternative = "greater")
...
wilcox.test(DTFormCustom$processus11 + 1, mu = 3, alternative = "greater")
...
wilcox.test(DTFormCustom$processus12 + 1, mu = 3, alternative = "greater")
...
wilcox.test(DTFormCustom$processus15 + 1, mu = 3, alternative = "less")
...
wilcox.test(DTFormCustom$processus16 + 1, mu = 3, alternative = "two.sided")
...
wilcox.test(DTFormCustom$processus17 + 1, mu = 3, alternative = "greater")
