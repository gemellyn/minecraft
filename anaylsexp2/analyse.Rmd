...
# Vous vouliez continuer à jouer pour connaître la suite des événements
barplot(table(DTFormCustom[nb > minNB]$narratif5 + 1), xlab="Réponses", ylab="Participants", main="", names.arg=c("Tout à fait d'accord", "d'accord", "ni en désaccord \n ni d'accord", "pas d'accord"), cex.names = 0.8)
