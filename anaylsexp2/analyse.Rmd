...
# Durant la partie vous étiez occupé par les événements qui s'y déroulaient
barplot(table(DTFormCustom[nb > minNB]$narratif3 + 1), xlab="Réponses", ylab="Participants", main="", names.arg=c("Tout à fait d'accord", "d'accord", "ni en désaccord \n ni d'accord", "pas d'accord"), cex.names = 0.8)
...
# Vous avez été marqué par les événements de la partie
barplot(table(DTFormCustom[nb > minNB]$narratif6 + 1), xlab="Réponses", ylab="Participants", main="", names.arg=c("Tout à fait d'accord", "d'accord", "ni en désaccord \n ni d'accord", "pas d'accord"), cex.names = 0.8)
