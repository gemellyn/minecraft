  ...
  if(grepl("data",d)){
    ...
    if(is_result){
      ...
      if(paste("test",form_file,sep="") != "test"){
        ...
        DTFormLieuxLoc$nbCharLieu1 <- nchar(as.character(DTFormLoc$lieu1_couleur))
        DTFormLieuxLoc$nbCharLieu2 <- nchar(as.character(DTFormLoc$lieu2_couleur))
        DTFormLieuxLoc$nbCharLieu3 <- nchar(as.character(DTFormLoc$lieu3_couleur))
        DTFormLieuxLoc$nbCharLieu4 <- nchar(as.character(DTFormLoc$lieu4_couleur))
        DTFormLieuxLoc$nbCharLieu5 <- nchar(as.character(DTFormLoc$lieu5_couleur))
        DTFormLieuxLoc$nbCharLieu6 <- nchar(as.character(DTFormLoc$lieu6_couleur))
        DTFormLieuxLoc$nbCharLieu7 <- nchar(as.character(DTFormLoc$lieu7_couleur))
        DTFormLieuxLoc$nbCharLieu8 <- nchar(as.character(DTFormLoc$lieu8_couleur))
        DTFormLieuxLoc$nbCharLieu9 <- nchar(as.character(DTFormLoc$lieu9_couleur))
        DTFormLieuxLoc$nbCharLieu10 <- nchar(as.character(DTFormLoc$lieu10_couleur))
        DTFormLoc$nbLieux <- (if (DTFormLieuxLoc$nbCharLieu1 > 2) 1 else 0) + (if (DTFormLieuxLoc$nbCharLieu2 > 2) 1 else 0) + (if (DTFormLieuxLoc$nbCharLieu3 > 2) 1 else 0) + (if (DTFormLieuxLoc$nbCharLieu4 > 2) 1 else 0) + (if (DTFormLieuxLoc$nbCharLieu5 > 2) 1 else 0) + (if (DTFormLieuxLoc$nbCharLieu6 > 2) 1 else 0) +(if (DTFormLieuxLoc$nbCharLieu7 > 2) 1 else 0) + (if (DTFormLieuxLoc$nbCharLieu8 > 2) 1 else 0) + (if (DTFormLieuxLoc$nbCharLieu9 > 2) 1 else 0) + (if (DTFormLieuxLoc$nbCharLieu10 > 2) 1 else 0)
