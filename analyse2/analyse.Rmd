...
#Wilcoxon signed rank pour voir voir que répondu sensiblement pas milieu 3
DT <- DTFormProcessInt;
DT$sens = DT$sens +1
DT[FirstCondition=="mod"]$sens = 6-DT[FirstCondition=="mod"]$sens;
barplot(table(DT$sens))
wilcox.test(DT$sens,mu=3, alternative = "less")
...
table(DT$faire)
wilcox.test(DT$faire,mu=3)

DT <- DTFormProcessInt;
DT$objectifs = DT$faire +1
DT[FirstCondition=="mod"]$faire = 6-DT[FirstCondition=="mod"]$faire;
table(DT$faire)
wilcox.test(DT$faire,mu=3)
