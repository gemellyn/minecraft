...
DTFormProcessInt[FirstCondition=="mod"][sens==0]$sens <- 5
DTFormProcessInt[FirstCondition=="mod"][sens==4]$sens <- 0
DTFormProcessInt[FirstCondition=="mod"][sens==1]$sens <- 6
DTFormProcessInt[FirstCondition=="mod"][sens==3]$sens <- 1
DTFormProcessInt[FirstCondition=="mod"][sens==6]$sens <- 3
DTFormProcessInt[FirstCondition=="mod"][sens==5]$sens <- 4
DTFormProcessInt[FirstCondition=="mod"][situations==0]$situations <- 5
DTFormProcessInt[FirstCondition=="mod"][situations==4]$situations <- 0
DTFormProcessInt[FirstCondition=="mod"][situations==1]$situations <- 6
DTFormProcessInt[FirstCondition=="mod"][situations==3]$situations <- 1
DTFormProcessInt[FirstCondition=="mod"][situations==6]$situations <- 3
DTFormProcessInt[FirstCondition=="mod"][situations==5]$situations <- 4
DTFormProcessInt[FirstCondition=="mod"][interet==0]$interet <- 5
DTFormProcessInt[FirstCondition=="mod"][interet==4]$interet <- 0
DTFormProcessInt[FirstCondition=="mod"][interet==1]$interet <- 6
DTFormProcessInt[FirstCondition=="mod"][interet==3]$interet <- 1
DTFormProcessInt[FirstCondition=="mod"][interet==6]$interet <- 3
DTFormProcessInt[FirstCondition=="mod"][interet==5]$interet <- 4
DTFormProcessInt[FirstCondition=="mod"][logique==0]$logique <- 5
DTFormProcessInt[FirstCondition=="mod"][logique==4]$logique <- 0
DTFormProcessInt[FirstCondition=="mod"][logique==1]$logique <- 6
DTFormProcessInt[FirstCondition=="mod"][logique==3]$logique <- 1
DTFormProcessInt[FirstCondition=="mod"][logique==6]$logique <- 3
DTFormProcessInt[FirstCondition=="mod"][logique==5]$logique <- 4
DTFormProcessInt[FirstCondition=="mod"][faire==0]$faire <- 5
DTFormProcessInt[FirstCondition=="mod"][faire==4]$faire <- 0
DTFormProcessInt[FirstCondition=="mod"][faire==1]$faire <- 6
DTFormProcessInt[FirstCondition=="mod"][faire==3]$faire <- 1
DTFormProcessInt[FirstCondition=="mod"][faire==6]$faire <- 3
DTFormProcessInt[FirstCondition=="mod"][faire==5]$faire <- 4
DTFormProcessInt[FirstCondition=="mod"][objectifs==0]$objectifs <- 5
DTFormProcessInt[FirstCondition=="mod"][objectifs==4]$objectifs <- 0
DTFormProcessInt[FirstCondition=="mod"][objectifs==1]$objectifs <- 6
DTFormProcessInt[FirstCondition=="mod"][objectifs==3]$objectifs <- 1
DTFormProcessInt[FirstCondition=="mod"][objectifs==6]$objectifs <- 3
DTFormProcessInt[FirstCondition=="mod"][objectifs==5]$objectifs <- 4
DTFormProcessInt[FirstCondition=="mod"][manques==0]$manques <- 5
DTFormProcessInt[FirstCondition=="mod"][manques==4]$manques <- 0
DTFormProcessInt[FirstCondition=="mod"][manques==1]$manques <- 6
DTFormProcessInt[FirstCondition=="mod"][manques==3]$manques <- 1
DTFormProcessInt[FirstCondition=="mod"][manques==6]$manques <- 3
DTFormProcessInt[FirstCondition=="mod"][manques==5]$manques <- 4
DTFormProcessInt[FirstCondition=="mod"][surpris==0]$surpris <- 5
DTFormProcessInt[FirstCondition=="mod"][surpris==4]$surpris <- 0
DTFormProcessInt[FirstCondition=="mod"][surpris==1]$surpris <- 6
DTFormProcessInt[FirstCondition=="mod"][surpris==3]$surpris <- 1
DTFormProcessInt[FirstCondition=="mod"][surpris==6]$surpris <- 3
DTFormProcessInt[FirstCondition=="mod"][surpris==5]$surpris <- 4
DTFormProcessInt[FirstCondition=="mod"][plaisir==0]$plaisir <- 5
DTFormProcessInt[FirstCondition=="mod"][plaisir==4]$plaisir <- 0
DTFormProcessInt[FirstCondition=="mod"][plaisir==1]$plaisir <- 6
DTFormProcessInt[FirstCondition=="mod"][plaisir==3]$plaisir <- 1
DTFormProcessInt[FirstCondition=="mod"][plaisir==6]$plaisir <- 3
DTFormProcessInt[FirstCondition=="mod"][plaisir==5]$plaisir <- 4


barplot(table(DTFormProcessInt$sens), xlab="Vanilla, plutôt vanilla, ni l'une ni l'autre, plutôt mod, mod", ylab="Participants", main="Quelle partie vous a semblé avoir le plus de sens ?", names.arg=c("Vanilla", "plutôt vanilla", "ni l'une ni l'autre", "plutôt mod", "mod"), cex.names = 1.0)
summary(DTFormCustom$sens)
wilcox.test(DTFormCustom$sens, mu = 3, alternative = "less", conf.int = T)

barplot(table(DTFormProcessInt$situations), xlab="Vanilla, plutot vanilla, ni l'une ni l'autre, plutôt mod, mod", ylab="Participants", main="Quelle partie vous a semblé la plus riche, la plus varié ?", names.arg=c("Vanilla", "plutôt vanilla", "ni l'une ni l'autre", "plutôt mod", "mod"), cex.names = 1.0)
summary(DTFormCustom$situations)
wilcox.test(DTFormCustom$situations, mu = 3, alternative = "less", conf.int = T)

barplot(table(DTFormProcessInt$interet), xlab="Vanilla, plutot vanilla, ni l'une ni l'autre, plutôt mod, mod", ylab="Participants", main="Pour quelle partie avez-vous ressenti le plus d'intérêt ?", names.arg=c("Vanilla", "plutôt vanilla", "ni l'une ni l'autre", "plutôt mod", "mod"), cex.names = 1.0)
summary(DTFormCustom$interet)
wilcox.test(DTFormCustom$interet, mu = 3, alternative = "less", conf.int = T)

barplot(table(DTFormProcessInt$logique), xlab="Vanilla, plutot vanilla, ni l'une ni l'autre, plutôt mod, mod", ylab="Participants", main="Quelle partie vous a semblé la plus chaotique ?", names.arg=c("Vanilla", "plutôt vanilla", "ni l'une ni l'autre", "plutôt mod", "mod"), cex.names = 1.0)
summary(DTFormCustom$logique)
wilcox.test(DTFormCustom$logique, mu = 3, alternative = "less", conf.int = T)

barplot(table(DTFormProcessInt$faire), xlab="Vanilla, plutot vanilla, ni l'une ni l'autre, plutôt mod, mod", ylab="Participants", main="Dans quelle partie était-il le plus difficile de savoir quoi faire ?", names.arg=c("Vanilla", "plutôt vanilla", "ni l'une ni l'autre", "plutôt mod", "mod"), cex.names = 1.0)
summary(DTFormCustom$faire)
wilcox.test(DTFormCustom$faire, mu = 3, alternative = "less", conf.int = T)

barplot(table(DTFormProcessInt$objectifs), xlab="Vanilla, plutot vanilla, ni l'une ni l'autre, plutôt mod, mod", ylab="Participants", main="Dans quelle partie était-il le plus difficile d'atteindre les objectifs que vous vous étiez fixés ?", names.arg=c("Vanilla", "plutôt vanilla", "ni l'une ni l'autre", "plutôt mod", "mod"), cex.names = 1.0)
summary(DTFormCustom$objectifs)
wilcox.test(DTFormCustom$objectifs, mu = 3, alternative = "less", conf.int = T)

barplot(table(DTFormProcessInt$manques), xlab="Vanilla, plutot vanilla, ni l'une ni l'autre, plutôt mod, mod", ylab="Participants", main="Dans quelle partie avez vous manqué de choses à voir ou à faire ?", names.arg=c("Vanilla", "plutôt vanilla", "ni l'une ni l'autre", "plutôt mod", "mod"), cex.names = 1.0)
summary(DTFormCustom$manques)
wilcox.test(DTFormCustom$manques, mu = 3, alternative = "less", conf.int = T)

barplot(table(DTFormProcessInt$surpris), xlab="Vanilla, plutot vanilla, ni l'une ni l'autre, plutôt mod, mod", ylab="Participants", main="Dans quelle partie avez vous été le plus surpris par les évènements ?", names.arg=c("Vanilla", "plutôt vanilla", "ni l'une ni l'autre", "plutôt mod", "mod"), cex.names = 1.0)
summary(DTFormCustom$surpris)
wilcox.test(DTFormCustom$surpris, mu = 3, alternative = "less", conf.int = T)

barplot(table(DTFormProcessInt$plaisir), xlab="Vanilla, plutot vanilla, ni l'une ni l'autre, plutôt mod, mod", ylab="Participants", main="Quelle partie vous a semblé la plus satisfaisante ?", names.arg=c("Vanilla", "plutôt vanilla", "ni l'une ni l'autre", "plutôt mod", "mod"), cex.names = 1.0)
summary(DTFormCustom$plaisir)
wilcox.test(DTFormCustom$plaisir, mu = 3, alternative = "less", conf.int = T)
...
```{r echo=FALSE}
# Distribution de l'interet pour les différents pouvoirs
barplot(rowSums(data.table(rbind(nrow(DTForm[autres_p1==0]), nrow(DTForm[autres_p1==1]), nrow(DTForm[autres_p1==2]), nrow(DTForm[autres_p1==3])))), main="Utiliseriez vous le pouvoir Compagnon dans d'autres contextes de jeu ou d'autres parties de Minecraft ?", xlab="Non, je ne sais pas, peut-être, oui absolument", ylab="Nombre de personnes")

barplot(rowSums(data.table(rbind(nrow(DTForm[autres_p2==0]), nrow(DTForm[autres_p2==1]), nrow(DTForm[autres_p2==2]), nrow(DTForm[autres_p2==3])))), main="Utiliseriez vous le pouvoir Roi des Lapins dans d'autres contextes de jeu ou d'autres parties de Minecraft ?", xlab="Non, je ne sais pas, peut-être, oui absolument", ylab="Nombre de personnes")

barplot(rowSums(data.table(rbind(nrow(DTForm[autres_p3==0]), nrow(DTForm[autres_p3==1]), nrow(DTForm[autres_p3==2]), nrow(DTForm[autres_p3==3])))), main="Utiliseriez vous le pouvoir Les autres dans d'autres contextes de jeu ou d'autres parties de Minecraft ?", xlab="Non, je ne sais pas, peut-être, oui absolument", ylab="Nombre de personnes")
```
