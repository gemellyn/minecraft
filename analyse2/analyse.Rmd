...
barplot(rowSums(data.table(rbind(DTFormSens$v, DTFormSens$pv, DTFormSens$n, DTFormSens$pm, DTFormSens$m))), main="A le plus de sens", xlab="Echelle (vanilla à mod)", ylab="Nombre de personnes")
barplot(rowSums(data.table(rbind(DTFormSituations$v, DTFormSituations$pv, DTFormSituations$n, DTFormSituations$pm, DTFormSituations$m))), main="La plus riche", xlab="Echelle (vanilla à mod)", ylab="Nombre de personnes")
barplot(rowSums(data.table(rbind(DTFormInteret$v, DTFormInteret$pv, DTFormInteret$n, DTFormInteret$pm, DTFormInteret$m))), main="A le plus d'interet", xlab="Echelle (vanilla à mod)", ylab="Nombre de personnes")
barplot(rowSums(data.table(rbind(DTFormLogique$v, DTFormLogique$pv, DTFormLogique$n, DTFormLogique$pm, DTFormLogique$m))), main="Est la plus chaotique", xlab="Echelle (vanilla à mod)", ylab="Nombre de personnes")
barplot(rowSums(data.table(rbind(DTFormFaire$v, DTFormFaire$pv, DTFormFaire$n, DTFormFaire$pm, DTFormFaire$m))), main="Difficile de savoir quoi faire", xlab="Echelle (vanilla à mod)", ylab="Nombre de personnes")
barplot(rowSums(data.table(rbind(DTFormObjectifs$v, DTFormObjectifs$pv, DTFormObjectifs$n, DTFormObjectifs$pm, DTFormObjectifs$m))), main="Difficile d'atteindre ses objectifs", xlab="Echelle (vanilla à mod)", ylab="Nombre de personnes")
barplot(rowSums(data.table(rbind(DTFormManques$v, DTFormManques$pv, DTFormManques$n, DTFormManques$pm, DTFormManques$m))), main="Manqué de choses à voir/faire", xlab="Echelle (vanilla à mod)", ylab="Nombre de personnes")
barplot(rowSums(data.table(rbind(DTFormSurpris$v, DTFormSurpris$pv, DTFormSurpris$n, DTFormSurpris$pm, DTFormSurpris$m))), main="Le plus surpris", xlab="Echelle (vanilla à mod)", ylab="Nombre de personnes")
barplot(rowSums(data.table(rbind(DTFormPlaisir$v, DTFormPlaisir$pv, DTFormPlaisir$n, DTFormPlaisir$pm, DTFormPlaisir$m))), main="La plus satisfaisante", xlab="Echelle (vanilla à mod)", ylab="Nombre de personnes")

# Distribution des caracteristiques de jeu par ordre de partie
...
barplot(rowSums(data.table(rbind(nrow(DTForm[autres_p1==0]), nrow(DTForm[autres_p1==1]), nrow(DTForm[autres_p1==2]), nrow(DTForm[autres_p1==3])))), main="Interet pour le process 1", xlab="Non, je ne sais pas, peut-être, oui absolument", ylab="Nombre de personnes")

barplot(rowSums(data.table(rbind(nrow(DTForm[autres_p2==0]), nrow(DTForm[autres_p2==1]), nrow(DTForm[autres_p2==2]), nrow(DTForm[autres_p2==3])))), main="Interet pour le process 2", xlab="Non, je ne sais pas, peut-être, oui absolument", ylab="Nombre de personnes")

barplot(rowSums(data.table(rbind(nrow(DTForm[autres_p3==0]), nrow(DTForm[autres_p3==1]), nrow(DTForm[autres_p3==2]), nrow(DTForm[autres_p3==3])))), main="Interet pour le process 3", xlab="Non, je ne sais pas, peut-être, oui absolument", ylab="Nombre de personnes")
