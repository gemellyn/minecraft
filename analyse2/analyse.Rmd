...
```{r echo=FALSE}
DTFormCustom <- DTFormProcessInt[nb >= 0]
```
...
```{r echo=FALSE}
hist(DTForm[FirstCondition=="vanilla"]$LongueurPremiere, xlab="Longueur des réponses", ylab="Nombre d'individus", main="Longueur des réponses pour vanilla si la première partie est en vanilla", breaks=30)
summary(DTForm[FirstCondition=="vanilla"]$LongueurPremiere)

hist(DTForm[FirstCondition=="mod"]$LongueurSeconde, xlab="Longueur des réponses", ylab="Nombre d'individus", main="Longueur des réponses pour vanilla si la première partie est en mod", breaks=30)
summary(DTForm[FirstCondition=="mod"]$LongueurSeconde)

# Moyennes de longueur des réponses
rowSums(rbind(DTForm[FirstCondition=="mod"]$LongueurPremiere)) / length(DTForm[FirstCondition=="mod"]) + rowSums(rbind(DTForm[FirstCondition=="vanilla"]$LongueurSeconde) / length(DTForm[FirstCondition=="vanilla"]))

rowSums(rbind(DTForm[FirstCondition=="vanilla"]$LongueurPremiere)) / length(DTForm[FirstCondition=="vanilla"]) + rowSums(rbind(DTForm[FirstCondition=="mod"]$LongueurSeconde) / length(DTForm[FirstCondition=="mod"]))

DTLongueurVanilla <- rbind(DTForm[FirstCondition=="vanilla"]$LongueurPremiere, DTForm[FirstCondition=="mod"]$LongueurSeconde)

hist(DTLongueurVanilla, xlab="Longueur des réponses", ylab="Nombre d'individus", main="Longueur des réponses pour vanilla", breaks=30)
summary(DTLongueurVanilla)

hist(DTForm[FirstCondition=="mod"]$LongueurPremiere, xlab="Longueur des réponses", ylab="Nombre d'individus", main="Longueur des réponses pour mod si la première partie est en mod", breaks=30)
summary(DTForm[FirstCondition=="mod"]$LongueurPremiere)

hist(DTForm[FirstCondition=="vanilla"]$LongueurSeconde, xlab="Longueur des réponses", ylab="Nombre d'individus", main="Longueur des réponses pour mod si la première partie est en vanilla", breaks=30)
summary(DTForm[FirstCondition=="vanilla"]$LongueurSeconde)

DTLongueurMod <- rbind(DTForm[FirstCondition=="mod"]$LongueurPremiere, DTForm[FirstCondition=="vanilla"]$LongueurSeconde)

hist(DTLongueurMod, xlab="Longueur des réponses", ylab="Nombre d'individus", main="Longueur des réponses pour mod", breaks=30)
summary(DTLongueurMod)

```

####Q3: Questionnaire comparatif
...
# Cohérence
barplot(table(DT$sens + 1), xlab="Tout à fait d'accord, d'accord, ni en désaccord ni d'accord, pas d'accord, pas du tout d'accord", ylab="Nombre de personnes", main="Vous avez gardé le contrôle sur les événements de la partie",las=2)
summary(DT$sens + 1)
wilcox.test(DT$sens + 1, mu = 3, alternative = "less", conf.int = T)
...
##### Si la première partie est en vanilla
...
##### Si la première partie est en mod
