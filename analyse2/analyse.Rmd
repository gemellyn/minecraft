...
(rowSums(rbind(DTForm[FirstCondition=="vanilla"]$LongueurPremiere)) + rowSums(rbind(DTForm[FirstCondition=="mod"]$LongueurSeconde))) / (nrow(DTForm[FirstCondition=="mod"]) + nrow(DTForm[FirstCondition=="vanilla"]))

(rowSums(rbind(DTForm[FirstCondition=="mod"]$LongueurPremiere)) + rowSums(rbind(DTForm[FirstCondition=="vanilla"]$LongueurSeconde))) / (nrow(DTForm[FirstCondition=="vanilla"]) + nrow(DTForm[FirstCondition=="mod"]))

# Figures
DTLongueurLoc1 <- c(DTForm[FirstCondition=="mod"]$LongueurSeconde, DTForm[FirstCondition=="vanilla"]$LongueurPremiere)
hist(DTLongueurLoc1, xlab="Nombre de caractères", ylab="Participants", main="", breaks=30)
summary(DTLongueurLoc1)

DTLongueurLoc2 <- c(DTForm[FirstCondition=="mod"]$LongueurPremiere, DTForm[FirstCondition=="vanilla"]$LongueurSeconde)
hist(DTLongueurLoc2, xlab="Nombre de caractères", ylab="Participants", main="", breaks=30)
summary(DTLongueurLoc2)

wilcox.test(DTLongueurLoc1, DTLongueurLoc2)

remove(DTLongueurLoc1);
remove(DTLongueurLoc2);
...
results <- wilcox.test(DTFormCustom$sens + 1, mu = 3, alternative = "less", conf.int = T)
results
results$estimate - 3
...
results <- wilcox.test(DTFormCustom$logique + 1, mu = 3, alternative = "greater", conf.int = T)
results
results$estimate - 3
...
results <- wilcox.test(DTFormCustom$interet + 1, mu = 3, alternative = "greater", conf.int = T)
results
results$estimate - 3
...
results <- wilcox.test(DTFormCustom$plaisir + 1, mu = 3, alternative = "less", conf.int = T)
results
results$estimate - 3
...
results <- wilcox.test(DTFormCustom$situations + 1, mu = 3, alternative = "greater", conf.int = T)
results
results$estimate - 3
...
results <- wilcox.test(DTFormCustom$manques + 1, mu = 3, alternative = "less", conf.int = T)
results
results$estimate - 3
...
results <- wilcox.test(DTFormCustom$surpris + 1, mu = 3, alternative = "greater", conf.int = T)
results
results$estimate - 3
...
results <- wilcox.test(DTFormCustom$faire + 1, mu = 3, alternative = "greater", conf.int = T)
results
results$estimate - 3
...
results <- wilcox.test(DTFormCustom$objectifs + 1, mu = 3, alternative = "less", conf.int = T)
results
results$estimate - 3
...
DTQ5 <- data.table(rbind(nrow(DTFormCustom[autres_p1==0]), nrow(DTFormCustom[autres_p1==1]), nrow(DTFormCustom[autres_p1==2]), nrow(DTFormCustom[autres_p1==3]), nrow(DTFormCustom[autres_p1==4])))
barplot(rowSums(DTQ5), main="", names.arg=c("non", "plutôt non", "je ne sais pas", "peut-être", "oui"), cex.names = 1)
summary(DTFormCustom$autres_p1 + 1)
results <- wilcox.test(DTFormCustom$autres_p1 + 1, mu = 2.5, alternative = "less", conf.int = T)
results
2.5 - results$estimate

# Utiliseriez vous le pouvoir Roi des Lapins dans d'autres contextes de jeu ou d'autres parties de Minecraft ?
DTQ5 <- data.table(rbind(nrow(DTFormCustom[autres_p2==0]), nrow(DTFormCustom[autres_p2==1]), nrow(DTFormCustom[autres_p2==2]), nrow(DTFormCustom[autres_p2==3]), nrow(DTFormCustom[autres_p2==4])))
barplot(rowSums(DTQ5), main="", names.arg=c("non", "plutôt non", "je ne sais pas", "peut-être", "oui"), cex.names = 1)
summary(DTFormCustom$autres_p2 + 1)
results <- wilcox.test(DTFormCustom$autres_p2 + 1, mu = 2.5, alternative = "less", conf.int = T)
results
2.5 - results$estimate

# Utiliseriez vous le pouvoir Les autres dans d'autres contextes de jeu ou d'autres parties de Minecraft ?
DTQ5 <- data.table(rbind(nrow(DTFormCustom[autres_p3==0]), nrow(DTFormCustom[autres_p3==1]), nrow(DTFormCustom[autres_p3==2]), nrow(DTFormCustom[autres_p3==3]), nrow(DTFormCustom[autres_p3==4])))
barplot(rowSums(DTQ5), main="", names.arg=c("non", "plutôt non", "je ne sais pas", "peut-être", "oui"), cex.names = 1)
summary(DTFormCustom$autres_p3 + 1)
results <- wilcox.test(DTFormCustom$autres_p3 + 1, mu = 2.5, alternative = "less", conf.int = T)
results
2.5 - results$estimate
